        ...
        <div class="col-sm-6">
          <div class="container mt-4">
            <div class="card p-4 mb-3">
              ...
              <div class="row g-2">
                <div class="col-md-6">
                  <input v-model="login.email" type="text" class="form-control" placeholder="Your name/Email" />
                </div>
                <div class="col-md-6">
            ...
            <div class="card p-4 mb-3">
              ...
              <div class="row g-2">
                ...
                <div class="col-md-6">
                  <input v-model="user.phone" type="text" class="form-control" placeholder="Phone Number*" />
                </div>
                <div class="col-md-12">
            ...
            <div class="card p-4">
              ...
              <div v-for="option in paymentOptions" :key="option.value" class="form-check">
                <input class="form-check-input" type="radio" v-model="paymentMethod" :value="option.value" @change="toggleCreditCardForm" />
                <label class="form-check-label">{{ option.label }}</label>
              </div>
              
              <div v-if="paymentMethod === 'Credit Card'" class="mt-3">
                <input type="text" class="form-control mt-2" placeholder="Name On Card*" v-model="creditCard.name" />
                <input type="text" class="form-control mt-2" placeholder="Card Numbers*" v-model="creditCard.number" />
                <div class="row g-2 mt-2">
                  <div class="col-md-6">
                    <input type="date" class="form-control" v-model="creditCard.expiry" />
                  </div>
                  <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="CVV*" v-model="creditCard.cvv" />
                  </div>
                </div>
              </div>
